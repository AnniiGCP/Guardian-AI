...
const Location = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full h-[calc(100vh-120px)] gap-6 animate-in fade-in zoom-in-95 duration-1000">
      
      {/* Map Area */}
      <div className="relative flex-1 rounded-[2rem] overflow-hidden shadow-2xl border border-border/50 bg-secondary">
        ...
        <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center pointer-events-none">
          ...
          <div className="relative w-14 h-14">
            <div className="absolute inset-0 rounded-full bg-primary opacity-20 scale-150 animate-ping"></div>
            ...
            <div className="relative w-full h-full bg-white rounded-full p-1 shadow-xl border-2 border-primary">
              <img className="w-full h-full rounded-full object-cover" alt="Emma" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAYfO0rXac708GrAtiWhCQVnscoTO03qH-slDq1bqeq89emT45_EQRbosilbCvloXVWsnD5BVkm87a7HLwhbWUMpZvIMD74VKDrdegwZaahyDDG6F7Vv21DRt2iGDv0Q_QiJquoHvSfORRo2FVTH0mz9t2y8XTCqJeg-Hu6IAl5U-OfnMYDI9dFWE0-5Q1NsqLC7xIejh4MuRN_jxF7FjyE82d1NRQrzszk62uIh8JS1RFvGDMHLqmY-5zFwvsVJHjseJEU8HXVZfmO" />
            </div>
          </div>
        </div>

        {/* Map Tools */}
        <div className="absolute right-4 bottom-4 glass-card rounded-full p-2 flex flex-col gap-2 pointer-events-auto shadow-lg border border-border/50">
      ...
      {/* Info Sidebar Area */}
      <div className="w-full lg:w-[400px] flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar pb-4">
        
        {/* Real-time Status Card */}
        <div className="glass-card rounded-[1.5rem] p-6 shadow-sm border border-border/50 hover:shadow-md transition-shadow">
        ...
        <div className="glass-card rounded-[1.5rem] p-6 shadow-sm border border-border/50 hover:shadow-md transition-shadow relative overflow-hidden">
